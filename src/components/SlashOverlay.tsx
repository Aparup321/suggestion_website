      ...
      {isVisible && (
        ...
        >
          ...
          <motion.div
            ...
            className="absolute w-[300%] h-6 bg-white blur-[1px] shadow-[0_0_60px_var(--hud-cyan)] transform -rotate-45"
          />
          ...
          <motion.div
            ...
            className="absolute w-[250%] h-20 bg-[var(--hud-cyan)] blur-[40px] transform -rotate-45"
          />
          ...
          <motion.div
            ...
            className="absolute w-[200%] h-2 bg-white blur-[1px] shadow-[0_0_30px_var(--hud-yellow)] transform -rotate-40"
          />
        </motion.div>
      )}
    </AnimatePresence>
