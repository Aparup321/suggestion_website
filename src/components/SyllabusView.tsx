    ...
    <section className="flex flex-col gap-12 w-full max-w-5xl mx-auto py-10 px-4 md:px-0">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 px-4">
        <div className="space-y-1">
          <p className="text-[11px] uppercase tracking-[0.4em] text-[var(--neo-luffy-red)] font-black">LOG_POSE_TRACKER.SYS</p>
          <h1 className="text-5xl font-black italic tracking-tighter text-white uppercase">LOG POSE <span className="text-[var(--neo-hat-yellow)]">MODULES</span></h1>
          <p className="text-slate-500 text-sm font-black uppercase tracking-wider">Navigate the Grand Line and track module completion</p>
        </div>
      </div>
          ...
          >
            <div className="flex flex-col items-start gap-4 border-l-[12px] border-[var(--neo-luffy-red)] pl-8 mb-12">
              <div className="space-y-1">
                ...
                <span className="text-[11px] font-mono text-[var(--neo-hat-yellow)] font-black uppercase tracking-widest leading-none">ISLAND_CODE // {subject.code || subject.id}</span>
              </div>
                ...
                <div className="grid md:grid-cols-2 gap-8 w-full mt-8 p-8 bg-black mesh-gradient border-[4px] border-black shadow-[12px_12px_0px_0px_#000]">
                  {subject.objective && (
                    <div className="md:col-span-2 space-y-3 border-b-2 border-black pb-6">
                      <p className="text-[10px] uppercase tracking-[0.3em] text-[var(--neo-luffy-red)] font-black">ADVENTURE_GOAL</p>
                      <p className="text-base text-slate-300 font-bold leading-relaxed">{subject.objective}</p>
                    </div>
                  )}
                  {subject.prerequisites && (
                    <div className="space-y-3">
                      <p className="text-[10px] uppercase tracking-[0.3em] text-[var(--neo-luffy-red)] font-black">PRE_REQUISITES</p>
                  ...
                  {subject.outcomes && (
                    <div className="space-y-3">
                      <p className="text-[10px] uppercase tracking-[0.3em] text-[var(--neo-luffy-red)] font-black">ADVENTURE_REWARD</p>
